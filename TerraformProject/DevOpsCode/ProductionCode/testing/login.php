...
<html lang="en">
	...
	<body>
            ...
            <ul class="fix">
                ...
                <li id="right">
          <button onclick="document.getElementById('id02').style.display='block'" class="userbutton" style="width:auto;">Sign Up</button>
        </li>
            </ul>
       ...
       modal.style.display = "none";
        ...
        <div>
            <form action="action.php" method="post">
                ...
                <a href="reset/reset.php" class="active">Reset Password</a>
    	</form>
