    ...
    <div class="container" style="width:600px; padding:0px;">
        <?php if (!empty($_SESSION['products'])) : ?>
            <nav class="navbar navbar-inverse" style="background:#04B745;">
                ...
                <div class="pull-right" style="margin-top:7px;margin-right:7px;"><a href="shop3.php?action=emptyall" class="btn btn-info">Empty cart</a></div>
            </nav>
            <table class="table table-striped">
                ...
                <?php foreach ($_SESSION['products'] as $key => $product) : ?>
                    <tr>
                        ...
                        <td><a href="shop3.php?action=empty&code=<?php print $key ?>" class="btn btn-info">Delete</a></td>
                    </tr>
	    ...
	    <?php foreach ($products as $product) : ?>   
	      <div class="col-md-4" style="height:300px; width:200px;"> 
				...
				<form method="post" action="shop3.php?action=addcart">
