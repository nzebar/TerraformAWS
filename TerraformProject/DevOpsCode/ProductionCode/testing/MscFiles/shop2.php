    ...
    <body>
	    ...
	    <!-- Start of hero image, This is where the picture with all of the containers includeing the nutsandbolts logo is located -->
            ...
            <ul class="fix">
				...
				<li>
                    <a href ="shop.html" class="hov">Shop</a>
                </li>
                <li id="right">
...
//$conn = new mysqli("localhost", "root", "raj240699", "cart");
    ...
    <div class="container" style="width:600px;">
        <?php if (!empty($_SESSION['products'])) : ?>
            <nav class="navbar navbar-inverse" style="background:#04B745;">
                ...
                <div class="pull-right" style="margin-top:7px;margin-right:7px;"><a href="shop2.php?action=emptyall" class="btn btn-info">Empty cart</a></div>
            </nav>
            <table class="table table-striped">
                ...
                <?php foreach ($_SESSION['products'] as $key => $product) : ?>
                    <tr>
                        ...
                        <td><a href="shop2.php?action=empty&code=<?php print $key ?>" class="btn btn-info">Delete</a></td>
                    </tr>
 ...
 <div class="col-md-4">
                        <div class="thumbnail"> <img src="<?php print $product['image'] ?>" alt="Lights">
                            <div class="caption">
                                ...
                                <form method="post" action="shop2.php?action=addcart">
      ...
      <div class="footer-lists">
        ...
        <div class="footer-list-wrap">
          ...
          <ul class="ftr-links-sub-column3">
            ...
            <li class="ftr-Login"><span class="link login-trigger"><a href="login.html"></a>Login</span></li>
